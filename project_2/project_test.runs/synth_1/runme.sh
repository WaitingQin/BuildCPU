...
HD_PWD='/headless/project_test/project_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log count_10.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source count_10.tcl
